...
public class MetadataTemplateFormBotServiceTest {
	...
	public void buildFormBotFormBadJson() throws Exception {
		...
		String mdTemplatePath1 = resolver.findOrCreateMetadataTemplatesCollection(targetIrodsCollection);
		...
		MetadataTemplateFormBotService formBotService = new MetadataTemplateFormBotService(accessObjectFactory,
				irodsAccount);

		String returnString = formBotService.buildFormBotForm(dummyJson);

		Assert.assertTrue("buildFormBotForm should have returned empty string", returnString.isEmpty());
	...
	public void buildFormBotFormUuidJson() throws Exception {
		...
		String mdTemplatePath = resolver.findOrCreateMetadataTemplatesCollection(targetIrodsCollection);

		DataTransferOperations dataTransferOperations = irodsFileSystem.getIRODSAccessObjectFactory()
				.getDataTransferOperations(irodsAccount);

		dataTransferOperations.putOperation(TEMPLATE_FILE_NAME1, mdTemplatePath,
				irodsAccount.getDefaultStorageResource(), null, null);
		...
		Assert.assertFalse("buildFormBotForm should not have returned empty string", returnString.isEmpty());

		FormBotForm returnForm = objectMapper.readValue(returnString, FormBotForm.class);

		Assert.assertTrue("buildFormBotForm should have returned a form populated from template1.mdtemplate",
				returnForm.getName().equalsIgnoreCase("test1"));

		// FormBotForm returnForm = formBotService.buildFormBotForm(uuidJson);
		//
		// Assert.assertNotNull("buildFormBotForm should not have returned
		// null",
		// returnForm);
	}
	...
	public void buildFormBotFormNameJson() throws Exception {
		...
		String nameJson = "{\n\t\"name\":\"test1\",\n\t\"activeDir\":\"" + targetIrodsCollection + "\"}";
	...
	public void validateFormBotFieldTemplateNotFound() throws Exception {
		...
		Assert.assertFalse("validateFormBotField should not have returned empty string", returnString.isEmpty());

		FormBotValidationResult returnResult = objectMapper.readValue(returnString, FormBotValidationResult.class);

		Assert.assertEquals("validateFormBotField should have returned an error", FormBotValidationEnum.ERROR,
	...
	public void validateFormBotFieldAttributeNotFound() throws Exception {
		...
		String fieldJson = "{\n\t\"value\":\"15\",\n\t\"fieldUniqueName\":\"" + uuid.toString() + "garbage\"}";
	...
	public void validateFormBotFieldValidationFailed() throws Exception {
		...
		//
		// Assert.assertEquals(
		// "validateFormBotField should have returned FAILURE, because value is
	...
	public void validateFormBotFieldValidationSuccess() throws Exception {
		...
		Assert.assertEquals("validateFormBotField should have returned SUCCESS", FormBotValidationEnum.SUCCESS,
				returnResult.getCode());
	...
	public void executeFormBotFieldTemplateNotFound() throws Exception {
		...
		dataTransferOperations.putOperation(TEST_FILE_NAME, targetIrodsCollection,
				irodsAccount.getDefaultStorageResource(), null, null);
		...
		Assert.assertFalse("executeFormBotField should not have returned empty string", returnString.isEmpty());

		FormBotExecutionResult returnResult = objectMapper.readValue(returnString, FormBotExecutionResult.class);

		Assert.assertEquals("executeFormBotField should have returned an error", FormBotExecutionEnum.ERROR,
				returnResult.getCode());
	...
	public void executeFormBotFieldValidationFailed() throws Exception {
		...
		//
		// Assert.assertEquals(
		// "validateFormBotField should have returned VALIDATION_FAILED, because
	...
	public void executeFormBotFieldValidationSuccess() throws Exception {
		...
		List<MetaDataAndDomainData> fileAvus = accessObjectFactory.getDataObjectAO(irodsAccount)
				.findMetadataValuesForDataObject(targetIrodsCollection, TEST_FILE_NOPATH);
		...
		Assert.assertEquals("validateFormBotField should have returned SUCCESS", FormBotExecutionEnum.SUCCESS,
				returnResult.getCode());
		Assert.assertEquals("executeFormBotField should have set metadata on file", "42", attribute2Value);
	}
	...
	public void validateFormBotFormBadJson() throws Exception {
		...
		Assert.assertFalse("validateFormBotForm should not have returned empty string", returnString.isEmpty());

		List<FormBotValidationResult> returnResultList = Arrays
				.asList(objectMapper.readValue(returnString, FormBotValidationResult[].class));

		Assert.assertEquals("validateFormBotForm should have returned an error", FormBotValidationEnum.ERROR,
				returnResultList.get(0).getCode());
	...
	public void validateFormBotFormValidationFailed() throws Exception {
		...
		String formJson = "{\"formUniqueName\" : \"" + uuid.toString()
		...
		Assert.assertEquals("validateFormBotForm return list should have 4 elements", 4, returnResultList.size());
		Assert.assertEquals("validateFormBotForm overall return value should be FAILURE", FormBotValidationEnum.FAILURE,
				returnResultList.get(0).getCode());
	...
	public void validateFormBotFormValidationSuccess() throws Exception {
		...
		Assert.assertEquals("validateFormBotForm return list should have 4 elements", 4, returnResultList.size());
		Assert.assertEquals("validateFormBotForm overall return value should be SUCCESS", FormBotValidationEnum.SUCCESS,
				returnResultList.get(0).getCode());
	...
	public void executeFormBotFormBadJson() throws Exception {
		...
		Assert.assertFalse("executeFormBotForm should not have returned empty string", returnString.isEmpty());

		List<FormBotExecutionResult> returnResultList = Arrays
				.asList(objectMapper.readValue(returnString, FormBotExecutionResult[].class));

		Assert.assertEquals("executeFormBotForm should have returned an error", FormBotExecutionEnum.ERROR,
				returnResultList.get(0).getCode());
	...
	public void executeFormBotFormValidationFailed() throws Exception {
		...
		Assert.assertEquals("executeFormBotForm return list should have 4 elements", 4, returnResultList.size());
		Assert.assertEquals("executeFormBotForm overall return value should be VALIDATION_FAILED",
				FormBotExecutionEnum.VALIDATION_FAILED, returnResultList.get(0).getCode());
		...
		// returnResult.size());
		// Assert.assertEquals(
		// "validateFormBotForm overall return value should be
		// VALIDATION_FAILED",
	...
	public void executeFormBotFormSuccess() throws Exception {
		...
		Assert.assertEquals("executeFormBotForm return list should have 4 elements", 4, returnResultList.size());
		Assert.assertEquals("executeFormBotForm overall return value should be SUCCESS", FormBotExecutionEnum.SUCCESS,
				returnResultList.get(0).getCode());
		...
		Assert.assertEquals("executeFormBotForm should have set metadata on file", "42", attribute2Value);
	}
